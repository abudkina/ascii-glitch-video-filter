...
- Ползунок **«Интенсивность эффектов»** (0–100%)
- Режим **Фотобудка** — квадратный кроп 1:1 и запись GIF-стикера (~2 сек, 480×480)
...
3. Настройте **интенсивность эффектов**.
4. По желанию включите **Фотобудку** для квадратных стикеров.
5. Выберите формат **Видеопетля** или **Гифка** (в фотобудке — всегда гифка), нажмите **«Записать»** / **«Стикер»**.
6. Нажмите **«Скачать»**.
